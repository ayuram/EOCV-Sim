...
public class RedShippingHubDetectionPipeline extends OpenCvPipeline {
    public RedShippingHubDetectionPipeline(){
        ret = new Mat();
        mat = new Mat();
    ...
    public Mat processFrame(Mat input) {
        ...
        try { // try catch in order for opMode to not crash and force a restart
            ...
            Imgproc.cvtColor(input, mat, Imgproc.COLOR_BGR2Lab); //red
